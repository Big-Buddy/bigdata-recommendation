...
als = ALS(rank=70, maxIter=5, regParam=0.01, userCol="userId", itemCol="movieId", ratingCol="global_avg_rating",
...
evaluator = RegressionEvaluator(metricName="rmse", labelCol="global_avg_rating",
