...
user_mean_df = training.groupby('userId').agg(training.avg('rating').alias('user-mean'))
item_mean_df = training.groupby('movieId').agg(training.avg('rating').alias('item-mean'))
